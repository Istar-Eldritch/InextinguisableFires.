...
cmd.exe /c mklink /J "C:\Program Files (x86)\Steam\steamapps\common\DayZ\IE\InextinguisableFires" "$(wslpath -w "$SCRIPT_DIR/..")"
cmd.exe /c mkdir "P:\IE"
cmd.exe /c mklink /J "P:\IE\InextinguisableFires" "$(wslpath -w "$SCRIPT_DIR/..")"
