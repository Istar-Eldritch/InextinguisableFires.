...
cmd.exe /c start /D "$WIN_DZ_PATH" DayZDiag_x64.exe -mission="$WIN_SCRIPT_DIR\mission\dayzOffline.chernarusplus" -mod="P:\Mods\@CF;P:\Mods\@COT;P:\Mods\@IEInextinguisableFires" -filePatching -server -profiles="$WIN_SCRIPT_DIR"\\profiles -config="$WIN_SCRIPT_DIR"\\serverDZ.cfg
